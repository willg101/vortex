...
<button class="btn" data-command="step_into"><span class="fa fa-fw fa-long-arrow-alt-down"></span></button>
<button class="btn" data-command="step_out"><span class="fa fa-fw fa-long-arrow-alt-up"></span></button>
